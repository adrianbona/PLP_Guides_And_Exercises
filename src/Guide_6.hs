...
----------------------------------- ax    ----------------------------------------- ax    ------------------------------------------------- ax
-- ∃X.(P(X) ⇒ Q(X)), ∀X.P(X) ⊢ ∀X.P(X)    ∃X.(P(X) ⇒ Q(X)), ∀X.P(X) ⊢ ∃X.(P(X) ⇒ Q(X))    ∃X.(P(X) ⇒ Q(X)), ∀X.P(X), P(Y) ⇒ Q(Y) ⊢ P(Y) ⇒ Q(Y)
----------------------------------- ∀e    ------------------------------------------------------------------------------------------------- ∃e
-- ∃X.(P(X) ⇒ Q(X)), ∀X.P(X) ⊢ P(Y)       ∃X.(P(X) ⇒ Q(X)), ∀X.P(X) ⊢ P(Y) ⇒ Q(Y)
------------------------------------------------------------------------------ ⇒e
-- ∃X.(P(X) ⇒ Q(X)), ∀X.P(X) ⊢ Q(Y)
-------------------------------- ∃i
-- ∃X.(P(X) ⇒ Q(X)), ∀X.P(X) ⊢ ∃X.Q(X)
...
------------------------- ax                                        ------------- ax    --------------------- ax
-- Γ ⊢ ∀X.∃Y.(R(Y,X) ⇒ P(X))                                        Γ ⊢ ∃X.∃Y.R(X,Y)    Γ, ∃Y.R(W,Y) ⊢ ∃Y.R(W,Y)
------------------------- ∀e    ----------------------------- ax    ----------------------------------------- ∃e    --------------- ax
-- Γ ⊢ ∃Y.(R(Y,Z) ⇒ P(Z))       Γ, R(W,Z) ⇒ P(Z) ⊢ R(W,Z) ⇒ P(Z)    Γ ⊢ ∃Y.R(W,Y)                                    Γ, R(W,Z) ⊢ R(W,Z)
------------------------------------------------------------- ∃e    ---------------------------------------------------------------- ∃e
-- Γ ⊢ R(W,Z) ⇒ P(Z)                                                Γ ⊢ R(W,Z)
--------------------------------------------------------------------------- ⇒e
-- Γ ⊢ P(Z)
...
--                                                                                                                         -------------------------------------- ax
--                                                                                                                         ∃X.(P(X) ∨ Q(X)), ∀X.¬Q(X), ¬P(Y) ⊢ ¬P(Y)
---------------------------------------------------- ax    --------------------------------------------------------- ax    ---------------------------------------------- ∧i
-- ∃X.(P(X) ∨ Q(X)), ∀X.¬Q(X), ¬P(Y) ⊢ ∃X.(P(X) ∨ Q(X))    ∃X.(P(X) ∨ Q(X)), ∀X.¬Q(X), ¬P(Y), P(Y) ∨ Q(Y) ⊢ P(Y) ∨ Q(Y)    ∃X.(P(X) ∨ Q(X)), ∀X.¬Q(X), ¬P(Y) ⊢ ¬P(Y) ∧ ¬Q(Y)
-------------------------------------------------------------------------------------------------------------------- ∃e    ---------------------------------------------- DM1
-- ∃X.(P(X) ∨ Q(X)), ∀X.¬Q(X), ¬P(Y) ⊢ P(Y) ∨ Q(Y)                                                                         ∃X.(P(X) ∨ Q(X)), ∀X.¬Q(X), ¬P(Y) ⊢ ¬(P(Y) ∨ Q(Y))
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ¬i
-- ∃X.(P(X) ∨ Q(X)), ∀X.¬Q(X), ¬P(Y) ⊢ ⊥
------------------------------------ PBC
-- ∃X.(P(X) ∨ Q(X)), ∀X.¬Q(X) ⊢ P(Y)
...
----------------------------------- ax    ---------------------------------------- ax    -------------------------------- ax    ---------------------------------------- ax
-- ∃X.(P(X) ∧ Q(X)) ⊢ ∃X.(P(X) ∧ Q(X))    ∃X.(P(X) ∧ Q(X)), P(Y) ∧ Q(Y) ⊢ P(Y) ∧ Q(Y)    ∃X.(P(X) ∧ Q(X)) ⊢ ∃X.(P(X) ∧ Q(X))    ∃X.(P(X) ∧ Q(X)), P(Y) ∧ Q(Y) ⊢ P(Y) ∧ Q(Y)
---------------------------------------------------------------------------------- ∃e    ------------------------------------------------------------------------------- ∃e
-- ∃X.(P(X) ∧ Q(X)) ⊢ P(Y) ∧ Q(Y)                                                        ∃X.(P(X) ∧ Q(X)) ⊢ P(Y) ∧ Q(Y)
----------------------------- ∧e1                                                        -------------------------- ∧e2
-- ∃X.(P(X) ∧ Q(X)) ⊢ P(Y)                                                               ∃X.(P(X) ∧ Q(X)) ⊢ Q(Y)
