...
--                                                                       ------------------------------------- ax
--                                                                       ∃X.∃Y.P(X,Y), ∃Y.P(X,Y), P(X,Y) ⊢ P(X,Y)
--                                                                       ---------------------------------------- ∃i
--                                                                       ∃X.∃Y.P(X,Y), ∃Y.P(X,Y), P(X,Y) ⊢ ∃X.P(X,Y)
--                                -------------------------------- ax    ------------------------------------------- ∃i
--                                ∃X.∃Y.P(X,Y), ∃Y.P(X,Y) ⊢ ∃Y.P(X,Y)    ∃X.∃Y.P(X,Y), ∃Y.P(X,Y), P(X,Y) ⊢ ∃Y.∃X.P(X,Y)
--------------------------- ax    ---------------------------------------------------------------------------------- ∃e
...
--                                -------------------------------- ax    ------------------------------------------- ∃i
--                                ∃Y.∃X.P(X,Y), ∃X.P(X,Y) ⊢ ∃X.P(X,Y)    ∃Y.∃X.P(X,Y), ∃X.P(X,Y), P(X,Y) ⊢ ∃X.∃Y.P(X,Y)
--------------------------- ax    ---------------------------------------------------------------------------------- ∃e
-- ∃Y.∃X.P(X,Y) ⊢ ∃Y.∃X.P(X,Y)    ∃Y.∃X.P(X,Y), ∃X.P(X,Y) ⊢ ∃X.∃Y.P(X,Y)
--------------------------------------------------------------------- ∃e
-- ∃Y.∃X.P(X,Y) ⊢ ∃X.∃Y.P(X,Y)
----------------------------- ⇒i
-- ⊢ ∃Y.∃X.P(X,Y) ⇒ ∃X.∃Y.P(X,Y)
...
--                                -------------------------------- ax
--                                ∃X.∀Y.P(X,Y), ∀Y.P(X,Y) ⊢ ∀Y.P(X,Y)
--                                -------------------------------- ∀e
--                                ∃X.∀Y.P(X,Y), ∀Y.P(X,Y) ⊢ P(X,Y)
--                                -------------------------------- ∃i
--                                ∃X.∀Y.P(X,Y), ∀Y.P(X,Y) ⊢ ∃X.P(X,Y)
--------------------------- ax    ----------------------------------- ∀i
-- ∃X.∀Y.P(X,Y) ⊢ ∃X.∀Y.P(X,Y)    ∃X.∀Y.P(X,Y), ∀Y.P(X,Y) ⊢ ∀Y.∃X.P(X,Y)
--------------------------------------------------------------------- ∃e
-- ∃X.∀Y.P(X,Y) ⊢ ∀Y.∃X.P(X,Y)
...
--                          ∃Z.P(Z,Z), P(Z,Z) ⊢ P(X,Y)
--                          -------------------------- ∃i
--                          ∃Z.P(Z,Z), P(Z,Z) ⊢ ∃Y.P(X,Y)
--------------------- ax    ----------------------------- ∃i
-- ∃Z.P(Z,Z) ⊢ ∃Z.P(Z,Z)    ∃Z.P(Z,Z), P(Z,Z) ⊢ ∃X.∃Y.P(X,Y)
--------------------------------------------------------- ∃e
-- ∃Z.P(Z,Z) ⊢ ∃X.∃Y.P(X,Y)
-------------------------- ⇒i
-- ⊢ ∃Z.P(Z,Z) ⇒ ∃X.∃Y.P(X,Y)
