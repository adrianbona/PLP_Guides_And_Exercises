...
--                                                                                 ------------------------------------------- ax
--                                                                                 ∀X.P(X) ∧ ∃X.¬P(X), ¬P(X) ⊢ ∀X.P(X) ∧ ∃X.¬P(X)
--                                                                                 ------------------------------------------ ∧e1
--                                                                                 ∀X.P(X) ∧ ∃X.¬P(X), ¬P(X) ⊢ ∀X.P(X)
--------------------------------------- ax    ------------------------------ ax    -------------------------------- ∀e
-- ∀X.P(X) ∧ ∃X.¬P(X) ⊢ ∀X.P(X) ∧ ∃X.¬P(X)    ∀X.P(X) ∧ ∃X.¬P(X), ¬P(X) ⊢ ¬P(X)    ∀X.P(X) ∧ ∃X.¬P(X), ¬P(X) ⊢ P(X)
-------------------------------------- ∧e2    ------------------------------------------------------------------ ¬e
-- ∀X.P(X) ∧ ∃X.¬P(X) ⊢ ∃X.¬P(X)              ∀X.P(X) ∧ ∃X.¬P(X), ¬P(X) ⊢ ⊥
------------------------------------------------------------------------ ∃e
-- ∀X.P(X) ∧ ∃X.¬P(X) ⊢ ⊥
...
--                                                                                                 --------------------------------------------------------- ax     ------------------------------------------------------- ax
--                                                                                                 ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X), ∀Y.¬R(X,Y) ⊢ R(X,X) ∧ P(X)    ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X), ∀Y.¬R(X,Y) ⊢ ∀Y.¬R(X,Y)
--                                                                                                 --------------------------------------------- ∧e1                ------------------------------------------------------- ∀e
--                                                                                                 ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X), ∀Y.¬R(X,Y) ⊢ R(X,X)           ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X), ∀Y.¬R(X,Y) ⊢ ¬R(X,X)
--                                                                                                 --------------------------------------------------------------------------------------------------------------------- ¬e
--                                                                                                 ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X), ∀Y.¬R(X,Y) ⊢ ⊥
--                                            ---------------------------------------------- ax    ---------------------------------------------- ¬i
--                                            ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X) ⊢ R(X,X) ∧ P(X)    ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X) ⊢ ¬∀Y.¬R(X,Y)
--                                            --------------------------------------------- ∧e2    -------------------------------------------- DM
--                                            ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X) ⊢ P(X)             ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X) ⊢ ¬¬∃Y.R(X,Y)
--                                            ------------------------------------------------------------------------------------------------- ∧i
--                                            ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X) ⊢ P(X) ∧ ¬¬∃Y.R(X,Y)
--                                            ---------------------------------------------------- CDI
--                                            ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X) ⊢ ¬(P(X) ⇒ ¬∃Y.R(X,Y))
--                                            -------------------------------------------------------- ∃i
--                                            ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X) ⊢ ∃X.¬(P(X) ⇒ ¬∃Y.R(X,Y))
--------------------------------------- ax    -------------------------------------------------------- DM
-- ∃X.(R(X,X) ∧ P(X)) ⊢ ∃X.(R(X,X) ∧ P(X))    ∃X.(R(X,X) ∧ P(X)), R(X,X) ∧ P(X) ⊢ ¬∀X.(P(X) ⇒ ¬∃Y.R(X,Y))
------------------------------------------------------------------------------------------------------ ∃e
...
------------------------------------- ax    ----------------------------------------- ∃i
-- ∃X.¬(P(X) ∨ Q(X)) ⊢ ∃X.¬(P(X) ∨ Q(X))    ∃X.¬(P(X) ∨ Q(X)), ¬(P(X) ∨ Q(X)) ⊢ ∃X.¬P(X)
------------------------------------------------------------------------------------- ∃e
-- ∃X.¬(P(X) ∨ Q(X)) ⊢ ∃X.¬P(X)
---------------------------- DM
-- ∃X.¬(P(X) ∨ Q(X)) ⊢ ¬∀X.P(X)
...
--                                                                          ----------------------------------------------------------------------------- ax
--                                                                          ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y), ∀Y.R(X,Y) ⊢ ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y)
--                                                                          ---------------------------------------------------------------------------- ∧e1    ----------------------------------------------------- ax
--                                                                          ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y), ∀Y.R(X,Y) ⊢ ∀X.(R(X,X) ⇒ Q(X))                   ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y), ∀Y.R(X,Y) ⊢ ∀Y.R(X,Y)
--                                                                          -------------------------------------------------------------- ∀e                   ----------------------------------------------------- ∀e
--                                                                          ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y), ∀Y.R(X,Y) ⊢ R(X,X) ⇒ Q(X)                        ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y), ∀Y.R(X,Y) ⊢ R(X,X)
--------------------------------------------------------------------- ax    -------------------------------------------------------------------------------------------------------------------------------------- ⇒e
-- ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y) ⊢ ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y)    ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y), ∀Y.R(X,Y) ⊢ Q(X)
-------------------------------------------------------------------- ∧e2    --------------------------------------------------- ∃i
-- ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y) ⊢ ∃X.∀Y.R(X,Y)                         ∀X.(R(X,X) ⇒ Q(X)) ∧ ∃X.∀Y.R(X,Y), ∀Y.R(X,Y) ⊢ ∃X.Q(X)
------------------------------------------------------------------------------------------------------------------------------- ∃e
