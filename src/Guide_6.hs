...
--                                                    ---------------------------------------------------- ax    ---------------------------------------------------- ax
--                                                    ∃X.∃Y.R(X,Y), ∃Y.R(X',Y), R(X',Y'), P(X',Y') ⊢ R(X',Y')    ∃X.∃Y.R(X,Y), ∃Y.R(X',Y), R(X',Y'), P(X',Y') ⊢ R(X',Y')
----------------------------------------------- ax    --------------------------------------------------------------------------------------------------------------- ∃e
-- ∃X.∃Y.R(X,Y), ∃Y.R(X',Y), P(X',Y') ⊢ ∃Y.R(X',Y)    ∃X.∃Y.R(X,Y), ∃Y.R(X',Y), P(X',Y') ⊢ R(X',Y')
------------------------------------------------------------------------------------------------ ∃e
-- ∃X.∃Y.R(X,Y), P(X',Y') ⊢ R(X',Y')
---------------------------------- ⇒i
-- ∃X.∃Y.R(X,Y) ⊢ P(X',Y') ⇒ R(X',Y')
------------------------------------- ∀i
-- ∃X.∃Y.R(X,Y) ⊢ ∀Y.(P(X',Y) ⇒ R(X',Y))
-------------------------------------- ∀i
-- ∃X.∃Y.R(X,Y) ⊢ ∀X.∀Y.(P(X,Y) ⇒ R(X,Y))
---------------------------------------- ⇒i
-- ⊢ ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)) ⇒ ∃X.∃Y.R(X,Y)
