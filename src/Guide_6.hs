...
--                                                                 ---------------------------------------- ∃i
--                                                                 ∃X.∃Y.P(X,Y), ∃Y.P(X,Y), P(X,Y) ⊢ ∃X.P(X,Y)
--                             ------------------------------ ?    ------------------------------------------- ∃i
--                             ∃X.∃Y.P(X,Y), ∃Y.P(X,Y) ⊢ P(X,Y)    ∃X.∃Y.P(X,Y), ∃Y.P(X,Y), P(X,Y) ⊢ ∃Y.∃X.P(X,Y)
------------------------- ?    ------------------------------------------------------------------------------- ∃e
...
--                                                                 ---------------------------------------- ∃i
--                                                                 ∃Y.∃X.P(X,Y), ∃X.P(X,Y), P(X,Y) ⊢ ∃Y.P(X,Y)
--                             ------------------------------ ?    ------------------------------------------- ∃i
--                             ∃Y.∃X.P(X,Y), ∃X.P(X,Y) ⊢ P(X,Y)    ∃Y.∃X.P(X,Y), ∃X.P(X,Y), P(X,Y) ⊢ ∃X.∃Y.P(X,Y)
------------------------- ?    ------------------------------------------------------------------------------- ∃e
...
--                                                                ∀X.P(X) ∨ σ, σ ⊢ P(X)
------------------------- ax    --------------------------- ax    --------------------- ∀i
-- ∀X.P(X) ∨ σ ⊢ ∀X.P(X) ∨ σ    ∀X.P(X) ∨ σ, ∀X.P(X) ⊢ ∀X.P(X)    ∀X.P(X) ∨ σ, σ ⊢ ∀X.P(X)
--------------------------------------------------------------------------------------- ∨e
-- ∀X.P(X) ∨ σ ⊢ ∀X.P(X)
--------------------- ∀e
-- ∀X.P(X) ∨ σ ⊢ P(X)
...
--                                          ------------------------------------- ∨1         ------------------------------------- ∨2
--                                          ∃X.P(X) ∨ ∃X.Q(X), ∃X.P(X) ⊢ P(X) ∨ Q(X)         ∃X.P(X) ∨ ∃X.Q(X), ∃X.Q(X) ⊢ P(X) ∨ Q(X)
------------------------------------- ax    ------------------------------------------ ∃i    ------------------------------------------ ∃i
...
-- ∃X.P(X) ∧ σ ⊢ ∃X.P(X) ∧ σ
------------------------ ∧e1    --------------------- ax    ---------------------- ax
-- ∃X.P(X) ∧ σ ⊢ ∃X.P(X)        ∃X.P(X) ∧ σ, P(X) ⊢ P(X)    ∃X.P(X) ∧ σ ⊢ ∃X.P(X) ∧ σ
----------------------------------------------------- ∃e    --------------------- ∧e2
-- ∃X.P(X) ∧ σ ⊢ P(X)                                       ∃X.P(X) ∧ σ ⊢ σ
------------------------------------------------------------------------- ∧i
-- ∃X.P(X) ∧ σ ⊢ P(X) ∧ σ
--------------------------- ∃i
-- ∃X.P(X) ∧ σ ⊢ ∃X.(P(X) ∧ σ)
...
-- ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)) ⇒ ∃X.∃Y.R(X,Y)

------------------------------------------------------ ax    ------------------------------------------------------------- ax
-- ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ ¬∃X.∃Y.R(X,Y)    ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ ∀X.∀Y.(P(X,Y) ⇒ R(X,Y))
------------------------------------------------------ DM    ------------------------------------------------------------- ∀e
-- ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ ∀X.∀Y.¬R(X,Y)    ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ ∀Y.(P(X',Y) ⇒ R(X',Y))
------------------------------------------------------ ∀e    ------------------------------------------------------------ ∀e     ----------------------------------------------- ?
-- ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ ∀Y.¬R(X',Y)      ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ P(X',Y') ⇒ R(X',Y')        ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ P(X',Y')
---------------------------------------------------- ∀e      ------------------------------------------------------------------------------------------------------------------ ⇒e
-- ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ ¬R(X',Y')        ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ R(X',Y')
----------------------------------------------------------------------------------------------------------- ¬e
-- ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)), ¬∃X.∃Y.R(X,Y) ⊢ ⊥
------------------------------------------ ¬i
-- ∀X.∀Y.(P(X,Y) ⇒ R(X,Y)) ⊢ ∃X.∃Y.R(X,Y)
